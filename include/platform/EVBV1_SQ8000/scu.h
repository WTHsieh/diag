/********************************************************************************
* File Name     : include/asm-arm/arch-sq/sq8000-scu.h
* Author        : Ryan Chen
* Description   : Sq SQ8000 SCU Service Header
*
...
#ifndef __SQ_SQ8000_SCU_H_INCLUDED
#define __SQ_SQ8000_SCU_H_INCLUDED
...
#if 0
#define SQ_SCU_CPU_CLOCK_258	9
#else
#define SQ_SCU_CPU_CLOCK_252 9
#endif
#define SQ_SCU_CPU_CLOCK_264	10
#define SQ_SCU_CPU_CLOCK_266	11
#define SQ_SCU_CPU_CLOCK_280	12
#define SQ_SCU_CPU_CLOCK_300	13
#define SQ_SCU_CPU_CLOCK_320	14
#define SQ_SCU_CPU_CLOCK_340	15
#define SQ_SCU_CPU_CLOCK_350	16
#define SQ_SCU_CPU_CLOCK_360	17
#define SQ_SCU_CPU_CLOCK_400	18
...
extern int sq_scu_mpll_status_get (void);	//return 1:normal	0:slow
	...
	/*	mclk enable 	*/
#define SQ_SCU_MCLK_DCM		26
#define SQ_SCU_MCLK_STSDR		25
#define SQ_SCU_MCLK_NFC			24
#define SQ_SCU_MCLK_HDMA		23
#define SQ_SCU_MCLK_VOP			22
#define SQ_SCU_MCLK_UHC0		21
#define SQ_SCU_MCLK_UDC		20
#define SQ_SCU_MCLK_UHC1		19
#define SQ_SCU_MCLK_MAC		18
#define SQ_SCU_MCLK_CLCD		17
#define SQ_SCU_MCLK_GPIO3		16
#define SQ_SCU_MCLK_GPIO2		15
#define SQ_SCU_MCLK_GPIO1		14
#define SQ_SCU_MCLK_GPIO0		13
#define SQ_SCU_MCLK_ADC		12
#define SQ_SCU_MCLK_PWM		11
#define SQ_SCU_MCLK_WDT		10
#define SQ_SCU_MCLK_RTC			9
#define SQ_SCU_MCLK_TIMER		8
#define SQ_SCU_MCLK_SDMMC		7
#define SQ_SCU_MCLK_I2S			6
#define SQ_SCU_MCLK_I2C			5
#define SQ_SCU_MCLK_SPI1		4
#define SQ_SCU_MCLK_SPI0		3
#define SQ_SCU_MCLK_UART2		2
#define SQ_SCU_MCLK_UART1		1
#define SQ_SCU_MCLK_UART0		0
...
extern int sq_scu_mclk_disable (int ip);
	...
	/*	aclk enable 	*/
#define SQ_SCU_ACLK_SDC_HARDMACRO	19
#define SQ_SCU_ACLK_MAC_HARDMACRO	18
#define SQ_SCU_ACLK_LCDC_HARDMACRO	17
#define SQ_SCU_ACLK_UDC_HARDMACRO	16
#define SQ_SCU_ACLK_MPLL_OSC_CRYSTAL	15
#define SQ_SCU_ACLK_MPLL_OSC_CLK		14
#define SQ_SCU_ACLK_ST_SDR				13
#define SQ_SCU_ACLK_HS_UART			12
#define SQ_SCU_ACLK_LCD_VOP			11
#define SQ_SCU_ACLK_MAC				10
#define SQ_SCU_ACLK_UHC0				9
#define SQ_SCU_ACLK_UHC1				8
#define SQ_SCU_ACLK_UTMI_UHC1			7
#define SQ_SCU_ACLK_UTMI_UHC0			6
#define SQ_SCU_ACLK_UDC					5
#define SQ_SCU_ACLK_ADC					4
#define SQ_SCU_ACLK_I2S					3
#define SQ_SCU_ACLK_UART2				2
#define SQ_SCU_ACLK_UART1				1
#define SQ_SCU_ACLK_UART0				0
