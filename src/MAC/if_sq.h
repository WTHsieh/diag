/* if_sq.h - SQ AHB MAC IP - Ethernet LAN network interface function header */
...
#define SQ_REG_OFFSET		0x08	/* quad word aligned */
...
#define sMAC_CSR(base,x)			((ULONG)(base) + ((SQ_REG_OFFSET) * (x)))
