/* if_sq.c - SQ AHB MAC IP - Ethernet LAN network interface driver */
    ...
    )
{
	...
	/* Find first PHY attached to Sq MAC */
...
/*******************************************************************************
*
* sMacInit - Sq MAC Initial procedure
*
* RETURNS: TRUE/FALSE
*/
...
{
    printf("Sq Mac Configuration Registers: CSR\n");
...
{
	printf("Sq Mac Device Content & Error : pDrvCtrl\n");
