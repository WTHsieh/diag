...
extern int sq_adc_test(int autotest);
...
extern int sq_adc_conv_w_poll(int autotest);
extern int sq_adc_conv_w_int(int autotest);
...
extern int sq_adc_ch_test_w_pwmt(int autotest);
extern int sq_adc_ch_test_w_board(int autotest);

struct test_item adc_main_test_items[] = {
	{
		"ADC Channel Test with PWMT",
		sq_adc_ch_test_w_pwmt,
		1,
		1
	},
	{
		"ADC Channel Test on Board",
		sq_adc_ch_test_w_board,
		0,
		1
	}
};
