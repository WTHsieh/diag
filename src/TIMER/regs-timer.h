...
#define TIMER_REG_BASE		SQ_APB1_TIMER
#endif

#ifndef TIMER_REG_BASE
#define TIMER_REG_BASE		SQ_APB0_TIMER
#endif

#define SQ_TMR0LR		(addr_t)(TIMER_REG_BASE + 0x0000)
#define SQ_TMR0CVR		(addr_t)(TIMER_REG_BASE + 0x0004)
#define SQ_TMR0CON		(addr_t)(TIMER_REG_BASE + 0x0008)
#define SQ_TMR1LR		(addr_t)(TIMER_REG_BASE + 0x0010)
#define SQ_TMR1CVR		(addr_t)(TIMER_REG_BASE + 0x0014)
#define SQ_TMR1CON		(addr_t)(TIMER_REG_BASE + 0x0018)
...
#define TMR0_SET_FLAG(flag)			(writew(readw(SQ_TMR0CON) |  flag, SQ_TMR0CON))
#define TMR0_CLR_FLAG(flag)			(writew(readw(SQ_TMR0CON) & ~flag, SQ_TMR0CON))
#define TMR0_CLR_INT()				(writew(readw(SQ_TMR0CON) & ~0x04, SQ_TMR0CON))
...
#define TMR0_PRESCALE(x)			(writew((readw(SQ_TMR0CON) & 0xffffff8f) | ((x) << TMR_PRESCALE_SHIFT), SQ_TMR0CON))
...
#define TMR1_SET_FLAG(flag)			(writew(readw(SQ_TMR1CON) |  flag, SQ_TMR1CON))
#define TMR1_CLR_FLAG(flag)			(writew(readw(SQ_TMR1CON) & ~flag, SQ_TMR1CON))
#define TMR1_CLR_INT()				(writew(readw(SQ_TMR1CON) & ~0x04, SQ_TMR1CON))
...
#define TMR1_PRESCALE(x)			(writew((readw(SQ_TMR1CON) & 0xffffff8f) | ((x) << TMR_PRESCALE_SHIFT), SQ_TMR1CON))
